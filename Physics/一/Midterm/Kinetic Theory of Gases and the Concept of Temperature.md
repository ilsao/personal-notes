...
通過物理測量，我們可以確定一莫耳的物質有多少個。這個常數稱**亞佛加厥數(Avogadro's number)**：
...
需要小心的是，以上的 $E_{k}=\frac{1}{2}m \bar{v^{2}}$ 為**平均**動能。
...
$$
\boxed{\Delta E_{k}=C_{v}n\Delta T=\Delta Q}
$$
