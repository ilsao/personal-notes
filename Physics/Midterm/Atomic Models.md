...
> [!note]
> 為了構建原子模型，Bohr 假設**軌道角動量**量子化。 回顧上述電子圓周運動的能量，發現與 $-\frac{1}{n^{2}}$ 成正比 (因為 $r\propto n^{2}$)。所以此假設也會使得能量量子化。
...
- stimulated emission：電子收到剛好等於能階差的能量，而從高階掉往低階。
